    ...
    <x-slot name="content" class="text-sm font-semibold text-left">
        <form wire:submit.prevent="setStatus" action="#" class="px-4 py-6 space-y-4">
            ...
            <div class="flex items-center space-x-3">
                <button type="button"
                    class="flex w-1/2 items-center justify-center px-4 py-3 font-semibold transition duration-100 ease-in bg-gray-200 border border-gray-200 h-11 rounded-xl hover:border-gray-400">
                ...
                <button type="submit"
                    class="flex w-1/2 items-center justify-center px-4 py-3 font-semibold text-white transition duration-100 ease-in border border-gray-200 h-11 bg-blue hover:bg-bluehover rounded-xl hover:border-gray-400">
                    Update
                </button>
            </div>
